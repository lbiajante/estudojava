...
public class AtualizarServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		writer.println("<header id='cabecalho-main'>"
				+ "<h3>Main - Atualizar </h3>"
				+ "<h1>Cadastro de Pessoas e Registros de Visitas</h1>"
				+ "<h2>por Leandro</h2><h3 class='dir'>Atualizado em nov/2018</h3></header>"

				+ "<form method='post' id='fAtualizar' action='RecebeAtualizarServlet'>"
				+ "<fieldset id='cadastro'><legend>Atualizar de Pessoas</legend>"

				+ "<p><label class='cadastro' for='cId'>ID: </label>"
				+ "<input type='number' name='tIdCadastro' id='cId' size='6' maxlength='6' placeholder='999999' required/></p>"
				...
				+ "<input type='image' name='tEnviarAtualizar' src='_imagens/botao-enviar.png' "
				+ "value='EnviarAtualizar' onclick='RecebeAtualizarServlet'>"
				+ "</fieldset></form>"

				+ "<form method='post' id='fAtualizarRegistro' action='RecebeAtualizarServlet'>"
				+ "<fieldset id='remover'><legend>Atualizar Registro de Visitas</legend>"				

				+ "<p><label class='registro' for='cIdVisita'>ID Visita: </label>"
